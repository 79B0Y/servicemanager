...
SERVICE_PORT="61830"
BINARY_PATH="/data/data/com.termux/files/usr/var/service/isgdida/isgdida"
...
check_install_status() {
    [[ -x "$BINARY_PATH" || $(dpkg -s isgdida 2>/dev/null | grep -q '^Status:') ]] && echo "true" || echo "false"
}
