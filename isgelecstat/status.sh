...
SERVICE_PORT="22101"
BINARY_PATH="/data/data/com.termux/files/usr/var/service/isgelecstat/isgelecstat"
...
check_install_status() {
    [[ -x "$BINARY_PATH" || $(dpkg -s isgelecstat 2>/dev/null | grep -q '^Status:') ]] && echo "true" || echo "false"
}
