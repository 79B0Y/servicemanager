...
SERVICE_PORT="61833"
BINARY_PATH="/data/data/com.termux/files/usr/var/service/isgtrigger/isgtrigger"
...
check_install_status() {
    [[ -x "$BINARY_PATH" || $(dpkg -s isgtrigger 2>/dev/null | grep -q '^Status:') ]] && echo "true" || echo "false"
}
