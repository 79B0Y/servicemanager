...
GUARDIAN_DATA_DIR="$GUARDIAN_INSTALL_DIR/data"
GUARDIAN_LOG_FILE="$GUARDIAN_INSTALL_DIR/isg-guardian.log"
...
if [[ "${BASH_SOURCE[0]}" == "${0}" ]]; then
    echo "isg-guardian 统一路径配置"
    echo "=========================="
    echo "SERVICE_ID: $SERVICE_ID"
    echo "BASE_DIR: $BASE_DIR"
    echo "GUARDIAN_INSTALL_DIR: $GUARDIAN_INSTALL_DIR"
    echo "GUARDIAN_CONFIG_FILE: $GUARDIAN_CONFIG_FILE"
