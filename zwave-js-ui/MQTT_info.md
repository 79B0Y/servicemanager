...
| MQTT 主题 | 状态值 | 消息内容 | 触发时机 |
|----------|--------|----------|----------|
| `isg/status/zwave-js-ui/status` | `running` | `{"service":"zwave-js-ui","status":"running","pid":1234,"runtime":"1:23:45","web_status":"online","port":"8190","timestamp":1234567890}` | 服务运行中 |
| `isg/status/zwave-js-ui/status` | `starting` | `{"service":"zwave-js-ui","status":"starting","pid":1234,"runtime":"0:01:30","web_status":"starting","port":"8190","timestamp":1234567890}` | 服务启动中 |
...
| `web_port` | 端口号 | Web 界面访问端口，通常为 8190 |
