...
SERVICE_PORT="22103"
BINARY_PATH="/data/data/com.termux/files/usr/var/service/isgdatamanager/isgdatamanager"
...
check_install_status() {
    [[ -x "$BINARY_PATH" || $(dpkg -s isgdatamanager 2>/dev/null | grep -q '^Status:') ]] && echo "true" || echo "false"
}
