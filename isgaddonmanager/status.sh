...
SERVICE_PORT="54328"
BINARY_PATH="/data/data/com.termux/files/usr/var/service/isgaddonmanager/isgaddonmanager"
...
check_install_status() {
    [[ -x "$BINARY_PATH" || $(dpkg -s isgaddonmanager 2>/dev/null | grep -q '^Status:') ]] && echo "true" || echo "false"
}
