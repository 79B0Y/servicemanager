...
# =============================================================================
# 函数：获取 android-tools 版本
# =============================================================================
get_android_tools_version() {
    pkg show android-tools 2>/dev/null | grep -oP '(?<=Version: )[0-9.]+' || echo "unknown"
}
