...
SERVICE_PORT="22102"
BINARY_PATH="/data/data/com.termux/files/usr/var/service/isgspacemanager/isgspacemanager"
...
check_install_status() {
    [[ -x "$BINARY_PATH" || $(dpkg -s isgspacemanager 2>/dev/null | grep -q '^Status:') ]] && echo "true" || echo "false"
}
