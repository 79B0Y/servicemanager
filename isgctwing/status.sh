...
SERVICE_PORT="22151"
BINARY_PATH="/data/data/com.termux/files/usr/var/service/isgctwing/isgctwing"
...
check_install_status() {
    [[ -x "$BINARY_PATH" || $(dpkg -s isgctwing 2>/dev/null | grep -q '^Status:') ]] && echo "true" || echo "false"
}
